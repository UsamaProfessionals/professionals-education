                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xxl-4 offset-xxl-4">
                                <div className="section__title-wrapper mb-100 text-center">
                                    <h2 className="section__title hover-underline-animation">Current <span className="yellow-bg yellow-bg-big">Events</span></h2>
                                    <p>We found 13 events available for you.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3">
                                <div className="events__item mb-10 hover__active">
                                    <div className="events__item-inner align-items-center white-bg">
                            ...
                            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3 pt-50 pt-sm">
                            ...
                            {/* <div className="col-xxl-3 offset-xxl-1 col-xl-3 offset-xl-1 col-lg-3 offset-lg-1">
                                <div className="events__item mb-10 hover__active">
