                        ...
                        <div className="row">
                            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                <Link href="/course-details">
                                    <div className="zoom banner__item p-relative mb-40" style={{ backgroundImage: ` linear-gradient(90deg, rgba(0, 0, 0, 0.483) 0%, rgba(0, 0, 0, 0.79) 100%, rgb(0, 0, 0) 100%), url(${'assets/img/banner/new-banner/new-banner-bg-1.jpg'})` }}>
