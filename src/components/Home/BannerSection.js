                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div className="banner__item p-relative mb-40" style={{ backgroundImage:` linear-gradient(90deg, rgba(0, 0, 0, 0.483) 0%, rgba(0, 0, 0, 0.79) 100%, rgb(0, 0, 0) 100%), url(${'assets/img/banner/new-banner/new-banner-bg-1.jpg'})`}}>
                                ...
                                {/* <img src="assets/img/banner/new-banner/new-banner-img-1.jpg" alt="img not found"/> */}
                                </div>
                            </div>
                        </div>
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div className="banner__item p-relative mb-40" style={{ backgroundImage:` linear-gradient(90deg, rgba(0, 0, 0, 0.483) 0%, rgba(0, 0, 0, 0.79) 100%, rgb(0, 0, 0) 100%), url(${'assets/img/banner/new-banner/new-banner-bg-2.jpg'})`}}>
                                <div className="banner__content">
                                ...
                                {/* <img src="assets/img/banner/new-banner/new-banner-img-2.jpg" alt="img not found"/> */}
                                </div>
                            </div>
                        </div>
                    </div>
