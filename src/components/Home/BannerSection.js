                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div className="banner__item p-relative mb-40" style={{ backgroundImage:`url(${'assets/img/banner/new-banner/new-banner-bg-1.jpg'})`}}>
                        ...
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div className="banner__item p-relative mb-40" style={{ backgroundImage:`url(${'assets/img/banner/new-banner/new-banner-bg-2.jpg'})`}}>
                                <div className="banner__content">
