...
import { GiMaterialsScience, GiSkills } from "react-icons/gi";
import { IoBusinessOutline, IoFitnessOutline } from "react-icons/io5";
import { BsBrush } from "react-icons/bs";
import { HiOutlineSpeakerphone, HiOutlineCurrencyDollar, HiOutlineAcademicCap } from "react-icons/hi";
                ...
                <Slider {...settings}>
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 px-3">
                        <div className="category__item mb-30 transition-3" style={{ backgroundImage: "url(assets/img/category/data-science.png)" }}>
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><Link href="/course-details"><a>Data & AI</a></Link></h4>
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 px-3">
                        <div className="category__item mb-30 transition-3" style={{ backgroundImage: "url(assets/img/category/business.png)" }}>
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><Link href="/course-details"><a>Business Intelligence</a></Link></h4>
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 px-3">
                        <div className="category__item mb-30 transition-3" style={{ backgroundImage: "url(assets/img/category/marketing.webp)" }}>
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><Link href="/course-details"><a>Digital Marketing</a></Link></h4>
                                <p>Improve your business</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 px-3">
                        <div className="category__item mb-30 transition-3" style={{ backgroundImage: "url(assets/img/category/finance.webp)" }}>
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><Link href="/course-details"><a>Finance & Insurance</a></Link></h4>
                                <p>Fun & Challenging</p>
                            </div>
                        </div>
                    </div>
