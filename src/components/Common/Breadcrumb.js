...
const Breadcrumb = (props) => {
   const { pageTitle } = props;
     return (
         <section className="page__title-area page__title-height page__title-overlay d-flex align-items-center" style={{ backgroundImage:`url(${'assets/img/page-title/page-title-1.jpg'})`}}>
