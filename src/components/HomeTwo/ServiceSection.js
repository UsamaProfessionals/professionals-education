            ...
            <div className="container">
               <div className="row">
                  <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                     <div className="section__title-wrapper section-padding mb-60 text-center">
                        <h2 className="section__title hover-underline-animation">Why an <span className="yellow-bg">scholercity </span> out of The ordinary</h2>
               ...
               <div className="row">
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div className="services__item blue-bg-4 mb-30 orange_bg" style={{backgroundColor: "#db4922"}}>
                  ...
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div className="services__item pink-bg mb-30 pink_bg" style={{backgroundColor: "#df62a1"}}>
                        <div className="services__icon">
                  ...
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div className="services__item purple-bg mb-30 purple_bg">
                        <div className="services__icon">
                  ...
                  <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div className="services__item green-bg mb-30 green_bg" style={{backgroundColor: "#50C878"}}>
                        <div className="services__icon">
                           <svg viewBox="0 0 512 512">
