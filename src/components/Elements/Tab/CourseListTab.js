                        ...
                        <div className="course__tab-conent">
                                                ...
                                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                                    <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                        <Link href="/course-details"><a>
                                                            <img src="assets/img/course/list/new-list/new-list-img-1.jpg" alt="img not found" />
                                                        </a></Link>
                                        ...
                                        <div className="course__item white-bg mb-30 fix">
                                            <div className="row gx-0">
                                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                                    <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                        <Link href="/course-details"><a>
                                                            <img src="assets/img/course/list/new-list/new-list-img-2.jpg" alt="img not found" />
                                                        </a></Link>
                                                        <div className="course__tag">
                                        ...
                                        <div className="course__item white-bg mb-30 fix">
                                            <div className="row gx-0">
                                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                                    <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                        <Link href="/course-details"><a>
                                                            <img src="assets/img/course/list/new-list/new-list-img-3.jpg" alt="img not found" />
                                                        </a></Link>
                                                        <div className="course__tag">
                                        ...
                                        <div className="course__item white-bg mb-30 fix">
                                            <div className="row gx-0">
                                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                                    <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                        <Link href="/course-details"><a>
                                                            <img src="assets/img/course/list/new-list/new-list-img-4.jpg" alt="img not found" />
                                                        </a></Link>
                                                        <div className="course__tag">
                                        ...
                                        <div className="course__item white-bg mb-30 fix">
                                            <div className="row gx-0">
                                                <div className="col-xxl-4 col-xl-4 col-lg-4">
                                                    <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                        <Link href="/course-details"><a>
                                                            <img src="assets/img/course/list/new-list/new-list-img-5.jpg" alt="img not found" />
                                                        </a></Link>
                                                        <div className="course__tag">
                            ...
                            <TabPanel>
                                <div className="row">
                                    ...
                                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                        <div className="flip-box course__item white-bg mb-30 fix">
                                            <div className="flip-box-front course__thumb w-img p-relative fix" style={{ backgroundImage: "url(assets/img/course/new-course/new-course-img-9.jpg)" }}>
                                                {/* <Link href="/course-details"><a>
                                                    <img src="assets/img/course/new-course/new-course-img-9.jpg" alt="img not found" />
                                                </a></Link> */}
                                                <div className="course__tag">
